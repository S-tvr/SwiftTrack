...
**Επόμενο βήμα**: Step 7 — Swagger sweep. Στην πράξη τα decorators γράφονται μέσα σε κάθε βήμα από το Step 2, άρα το 7 είναι έλεγχος πληρότητας (λείπουν 400/404/409 σε παλιότερα modules — βλ. σημείωση Step 2) και όχι νέα δουλειά.

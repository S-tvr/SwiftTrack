...
- The setup-code dialog, opened after a create (**Activation code**) and after a re-issue (**New activation code**) — one component, two call sites. Body: *"Give this code to &lt;name&gt;. It is the only way they can sign in for the first time."*
...
- The one toast on the page: *"&lt;name&gt; has been deactivated. Their row is under “Show deactivated”."* The other five writes take none — see architecture.md § Invariants for the rule and for why deactivate is the exception.
